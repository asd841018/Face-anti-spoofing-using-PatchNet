...
if __name__ == "__main__":
    ...
    model.eval()
    map_x, x_concat, x_Block1, x_Block2, x_Block3, x_input = model(x)
    print(f'map_x shape : {map_x.shape}')
    print(f'x_concat shape : {x_concat.shape}')
    print(f'x_Block1 shape : {x_Block1.shape}')
    print(f'x_Block2 shape : {x_Block2.shape}')
    print(f'x_Block3 shape : {x_Block3.shape}')